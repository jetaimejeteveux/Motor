...
import kotlinx.android.synthetic.main.activity_signup_photo_screen.*
import java.util.*
...
class SignupPhotoScreenActivity : AppCompatActivity(),PermissionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_signup_photo_screen)
        ...
        iv_add.setOnClickListener {
            if (statusAdd) {
                ...
                iv_profile.setImageResource(R.drawable.ic_person_black_24dp)
